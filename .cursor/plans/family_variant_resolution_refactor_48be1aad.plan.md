...
todos:
  ...
  - id: exports-tests
    ...
    status: completed
  - id: docs-workspace
    content: Update docs/reference/locations/location-workspace.md (variant resolution + pointers)
    status: pending
  - id: tray-primitives
...
| [`docs/reference/locations/location-workspace.md`](docs/reference/locations/location-workspace.md) | **Optional:** Map editor toolbar / paint tray bullet: structural parity with place tray + pointer to `leftTools/tray/` primitives. |
...
- **Docs:** [`location-workspace.md`](docs/reference/locations/location-workspace.md) reads correctly and links/paths match implemented modules after the refactor.
...
5. Update [`docs/reference/locations/location-workspace.md`](docs/reference/locations/location-workspace.md) per the **Files to change** row (variant resolution note + optional pointer).
