...
/** 3.5e Wealth By Level (DMG Table 5-1).
 *  Nearly identical to 3e; level 1 uses class-specific classInitialGold / avgGold. */
export const startingWealthTiers35e: WealthTier[] = [
