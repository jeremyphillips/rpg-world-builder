...
export const monstersLankhmar: readonly Monster[] = [
  ...
  },
  {
    ...
    mechanics: {
      ...
      thac0: 17,
      movement: { ground: 12 },
      attacks: [{ name: "Ice Touch", dice: "2-8" }],
  ...
  },
  {
    ...
    mechanics: {
      ...
      thac0: 15,
      movement: { ground: 3 },
      attacks: [{ name: "Constrict", dice: "2-12" }],
