...
} from './editions/proficiencySkillsByEdition'

import { FULL_CASTER_SLOTS_5E, WARLOCK_PACT_SLOTS_5E } from './classes/spellSlotTables'

export const classesCore: readonly CharacterClass[] = [
  { 
    id: 'fighter',
    name: 'Fighter',
  ...
  { 
    ...
    progression: {
      ...
      asiLevels: [4, 6, 8, 12, 14, 16, 19],
      features: [
        { level: 1, name: 'Arcane Tradition' },
        { level: 1, name: 'Spellcasting' },
        { level: 2, name: 'Arcane Recovery' },
        { level: 3, name: 'Arcane Tradition' },
