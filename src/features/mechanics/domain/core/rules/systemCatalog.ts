...
import type { Spell, SkillProficiency } from '@/features/content/shared/domain/types'
...
import type { Armor, Gear, MagicItem, Race, Weapon } from '@/features/content/shared/domain/types'
