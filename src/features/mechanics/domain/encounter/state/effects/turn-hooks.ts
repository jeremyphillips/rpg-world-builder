...
import { autoFailsSave, getSaveModifiersFromConditions } from '../conditions/condition-rules/condition-queries'
import { isImmuneToConditionIncludingScopedGrants } from '../conditions/condition-immunity-resolution'
