...
export default function MagicItemsListRoute() {
  ...
  const initialFilterValues = useMemo(() => {
    ...
    const hide = user?.preferences?.ui?.contentLists?.magicItems?.hideDisallowed;
    return {
      allowedInCampaign: hide ? 'true' : 'all',
    };
  }, [canManage, user?.preferences?.ui?.contentLists?.magicItems?.hideDisallowed]);
