  ...
  const playSurface = useEncounterActivePlaySurface(
    {
      ...
      selectedDoorCellIdA: encounter.selectedDoorCellIdA,
      setSelectedDoorCellIdA: encounter.setSelectedDoorCellIdA,
      selectedDoorCellIdB: encounter.selectedDoorCellIdB,
      setSelectedDoorCellIdB: encounter.setSelectedDoorCellIdB,
      suppressSameSideHostile,
      spellsById: catalog.spellsById,
      encounterDirective,
      ...
      handleOpenDoor: encounter.handleOpenDoor,
    },
