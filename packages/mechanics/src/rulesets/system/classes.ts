...
const CLASSES_RAW: readonly CharacterClass[] = [
  {
    ...
    progression: {
      ...
      features: [
        { id: 'fighting-style', level: 1, name: 'Fighting Style', description: '' },
        { id: 'second-wind', level: 1, name: 'Second Wind', description: '' },
        { id: 'action-surge', level: 2, name: 'Action Surge', description: '' },
        { id: 'martial-archetype', level: 3, name: 'Martial Archetype', description: '' },
        { id: 'extra-attack', level: 5, name: 'Extra Attack', description: '' },
        { id: 'indomitable', level: 9, name: 'Indomitable', description: '' },
        { id: 'extra-attack-2', level: 11, name: 'Extra Attack (2)', description: '' },
        { id: 'extra-attack-3', level: 20, name: 'Extra Attack (3)', description: '' },
      ],
    },
    proficiencies: {
  ...
  },
  {
    ...
    progression: {
      ...
      features: [
        { id: 'spellcasting', level: 1, name: 'Spellcasting', description: '' },
        { id: 'divine-domain', level: 1, name: 'Divine Domain', description: '' },
        { id: 'channel-divinity', level: 2, name: 'Channel Divinity', description: '' },
        { id: 'destroy-undead', level: 5, name: 'Destroy Undead', description: '' },
        { id: 'divine-intervention', level: 10, name: 'Divine Intervention', description: '' },
        {
  ...
  },
  {
    ...
    progression: {
      ...
      extraAttackLevel: 5,
      features: [
        { id: 'prime_hunter', name: 'Favored Enemy', level: 1, description: '' },
        { id: 'weapon_mastery', name: 'Weapon Mastery', level: 1, description: '' },
        { id: 'deft_explorer', name: 'Deft Explorer', level: 2, description: '' },
        {
          id: 'roving',
          name: 'Roving',
          level: 6,
  ...
  },
  {
    ...
    progression: {
      ...
      asiLevels: [4, 8, 12, 16, 19],
      features: [
        { id: 'otherworldly-patron', level: 1, name: 'Otherworldly Patron', description: '' },
        { id: 'pact-magic', level: 1, name: 'Pact Magic', description: '' },
        { id: 'eldritch-invocations', level: 2, name: 'Eldritch Invocations', description: '' },
        { id: 'pact-boon', level: 3, name: 'Pact Boon', description: '' },
        { id: 'mystic-arcanum', level: 11, name: 'Mystic Arcanum', description: '' },
        { id: 'eldritch-master', level: 20, name: 'Eldritch Master', description: '' },
      ],
    },
    proficiencies: {
      skills: { type: 'choice', choose: 2, level: 1 },
  ...
  },
  {
    ...
    progression: {
      ...
      features: [
        { id: 'spellcasting', level: 1, name: 'Spellcasting', description: '' },
        { id: 'sorcerous-origin', level: 1, name: 'Sorcerous Origin', description: '' },
        { id: 'font-of-magic', level: 2, name: 'Font of Magic', description: '' },
        { id: 'metamagic', level: 3, name: 'Metamagic', description: '' },
        { id: 'sorcerous-restoration', level: 20, name: 'Sorcerous Restoration', description: '' },
      ],
    },
    proficiencies: {
      skills: { type: 'choice', choose: 2, level: 1 },
  ...
  },
  {
    ...
    progression: {
      ...
      features: [
        ...
        { id: 'barbarian.feature.rage', level: 1, name: 'Rage', description: '' },
        { id: 'barbarian.feature.reckless_attack', level: 2, name: 'Reckless Attack', description: '' },
        { id: 'barbarian.feature.danger_sense', level: 2, name: 'Danger Sense', description: '' },
        { id: 'barbarian.feature.primal_path', level: 3, name: 'Primal Path', description: '' },
        { id: 'barbarian.feature.extra_attack', level: 5, name: 'Extra Attack', description: '' },
        { id: 'barbarian.feature.fast_movement', level: 5, name: 'Fast Movement', description: '' },
        { id: 'barbarian.feature.feral_instinct', level: 7, name: 'Feral Instinct', description: '' },
        { id: 'barbarian.feature.brutal_critical', level: 9, name: 'Brutal Critical', description: '' },
        { id: 'barbarian.feature.relentless_rage', level: 11, name: 'Relentless Rage', description: '' },
        { id: 'barbarian.feature.persistent_rage', level: 15, name: 'Persistent Rage', description: '' },
        { id: 'barbarian.feature.indomitable_might', level: 18, name: 'Indomitable Might', description: '' },
        { id: 'barbarian.feature.primal_champion', level: 20, name: 'Primal Champion', description: '' },
      ],
    },
    proficiencies: {
      skills: { type: 'choice', choose: 2, level: 1 },
  ...
  },
  {
    ...
    progression: {
      ...
      asiLevels: [4, 8, 12, 16, 19],
      features: [
        { id: 'wizard.feature.spellcasting', level: 1, name: 'Spellcasting', description: '' },
        { id: 'wizard.feature.arcane_recovery', level: 1, name: 'Arcane Recovery', description: '' },
        { id: 'wizard.feature.arcane_tradition', level: 2, name: 'Arcane Tradition', description: '' },
        { id: 'wizard.feature.spell_mastery', level: 18, name: 'Spell Mastery', description: '' },
        { id: 'wizard.feature.signature_spells', level: 20, name: 'Signature Spells', description: '' },
      ],
    },
    proficiencies: {
      skills: { type: 'choice', choose: 2, level: 1 },
