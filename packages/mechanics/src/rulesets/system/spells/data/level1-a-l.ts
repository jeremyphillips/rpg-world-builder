...
export const SPELLS_LEVEL_1_A_L: readonly SpellEntry[] = [
    ...
    },
    {
        ...
        level: 1,
        classes: ['paladin'],
        castingTime: { normal: { value: 1, unit: 'bonus-action', trigger: 'immediately after hitting with melee weapon or Unarmed Strike' }, canBeCastAsRitual: false },
        range: { kind: 'self' },
        duration: { kind: 'instantaneous' },
        components: { verbal: true },
        resolution: {
    ...
    },
    {
        ...
        level: 1,
        classes: ['ranger'],
        castingTime: { normal: { value: 1, unit: 'bonus-action', trigger: 'immediately after hitting creature with a weapon' }, canBeCastAsRitual: false },
        range: { kind: 'self' },
        duration: { kind: 'timed', value: 1, unit: 'minute', concentration: true, upTo: true },
        components: { verbal: true },
        resolution: {
    ...
    },
    {
        ...
        level: 1,
        classes: ['bard', 'sorcerer', 'wizard'],
        castingTime: { normal: { value: 1, unit: 'reaction', trigger: 'when you or a creature you can see within 60 feet of you falls' }, canBeCastAsRitual: false },
        range: { kind: 'distance', value: { value: 60, unit: 'ft' } },
        duration: { kind: 'timed', value: 1, unit: 'minute' },
    ...
    },
    {
        ...
        level: 1,
        classes: ['wizard'],
        castingTime: { normal: { value: 1, unit: 'hour' }, canBeCastAsRitual: true },
