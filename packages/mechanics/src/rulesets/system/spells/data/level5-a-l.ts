...
export const SPELLS_LEVEL_5_A_L: readonly SpellEntry[] = [
    ...
    },
    {
        ...
        level: 5,
        classes: ['bard', 'druid'],
        castingTime: { normal: { value: 8, unit: 'hour' }, canBeCastAsRitual: false },
        range: { kind: 'touch' },
    ...
    },
    {
        ...
        effectGroups: [
            {
                targeting: { target: 'creatures-in-area', targetType: 'creature', area: { kind: 'cylinder', size: 10 } },
                effects: [
                    {
                        kind: 'save',
                        save: { ability: 'dex' },
    ...
    },
    {
        ...
        level: 5,
        classes: ['cleric'],
        castingTime: { normal: { value: 24, unit: 'hour' }, canBeCastAsRitual: false },
        range: { kind: 'touch' },
