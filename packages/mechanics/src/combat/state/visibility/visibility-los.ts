...
/**
 * Grid line-of-sight: same supercover geometry as {@link hasLineOfSight} (interiors + edges).
 * When space/placements are missing, returns `true` (backwards-compatible with non-tactical state).
 */
